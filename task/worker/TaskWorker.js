...
const start = function(
  ...
  if (shouldIncludeInterReaction !== true) {
    shouldIncludeInterReaction = false;
  }

  if (withCustomTagName !== true) {
    withCustomTagName = false;
  }
  ...
  if (shouldIncludeInterReaction) {
    cmd = `${cmd}:interreaction`;
  }
  ...
  if (withCustomTagName) {
    cmd = `${cmd}:custom-tagname`;
  }
