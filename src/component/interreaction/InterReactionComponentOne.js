...
import HandsomePenguin from 'component/interreaction/asset/image/penguin-1_463-384.jpg';

class InterReactionComponentOne extends React.Component {
  componentDidMount() {
    console.log('InterReactionComponentOne mounted. HALLO!');
  }

  componentDidUpdate(prevProps, prevState) {
    console.log('InterReactionComponentOne updated.');
  }

  componentWillUnmount() {
    console.log('InterReactionComponentOne is unmounting. GOOD BYE!');
  }

  render() {
    return (
      <section className={ `${InterReactionComponentClassNames.COMPONENT} ${InterReactionComponentClassNames.COMPONENT}_one` }>
        <img
...
export default InterReactionComponentOne;
