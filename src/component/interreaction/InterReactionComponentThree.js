...
import HandsomePenguin from 'component/interreaction/asset/image/penguin-3_463-384.jpg';

const InterReactionComponentThree = function(props) {
  console.log('InterReactionComponentThree is mounting. HALLO!');

  return (
    <section className={ `${InterReactionComponentClassNames.COMPONENT} ${InterReactionComponentClassNames.COMPONENT}_three` }>
      <img
...
export default InterReactionComponentThree;
