...
const InterReactionComponentClassNames = Object.freeze({
  COMPONENT: 'interReactionComponent',
  COMPONENT_TYPE_FIELD: 'type',
  IMG_FIELD: 'image',
  MSG_FIELD: 'message',
  RENDER_DATETIME_FIELD: 'datetime'
});

export default InterReactionComponentClassNames;
