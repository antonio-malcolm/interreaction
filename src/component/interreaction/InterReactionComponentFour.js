...
import HandsomePenguin from 'component/interreaction/asset/image/penguin-4_463-384.jpg';

const InterReactionComponentFour = function(props) {
  console.log('InterReactionComponentFour is mounting. HALLO!');

  return (
    <section className={ `${InterReactionComponentClassNames.COMPONENT} ${InterReactionComponentClassNames.COMPONENT}_four` }>
      <img
...
export default InterReactionComponentFour;
