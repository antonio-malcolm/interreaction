...
Or:
```shell
$ npm install --save react@17.0.2 react-dom@17.0.2 scheduler@0.20.2 interreaction@1.0.6
```
...
Or:
```shell
$ npm install --save preact@10.5.13 interpreaction@1.0.6
```
