...
const appIndexFileName = 'interpreaction.js';
...
const workspacePathAbsolute = `${Paths.WORKSPACES_ABSOLUTE}/interpreaction`;
...
if (!(fs.existsSync(buildDistDevDirPathAbsolute) && fs.statSync(buildDistDevDirPathAbsolute).isDirectory())) {
  throw new SimpleBuildTimeException(
      ...
      './workspaces/interpreaction/task/makeReleaseDist.js'
    );
}
...
try {
  ...
  throw new SimpleBuildTimeException(
      ...
      './workspaces/interpreaction/makeReleaseDist.js',
      err
    );
}
